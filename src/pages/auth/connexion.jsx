    ...
    <div className="max-w-[400px] m-auto Tablette:max-w-[300px] mobil:max-w-[300px]">
      ...
      <div className="flex flex-col justify-center my-10 px-4">
        <div className="border p-10 Tablette:p-5 mobil:p-3 MiniPortable:p-2">
          <h1 className="text-center text-3xl MiniPortable:text-xl">
        ...
        <div className="text-center">
          <Link to={"/store.shopiline.cm/inscription"}>
            <button className="bg-neutral-100 border shadow-md p-3 rounded font-inter text-sm MiniPortable:text-xs">
              Inscription sur SHOPILINE{" "}
            </button>
          </Link>
        </div>
      </div>
