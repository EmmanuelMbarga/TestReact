    ...
    <>
      <div className="flex items-center mr-[2%] Laptop:mr-[2%] Tablette:mr-[2%] MiniPortable:flex-col">
        ...
        <div className="MiniPortable:text-center">
          <h1 className="text-5xl uppercase font-bold Tablette:text-xl mobil:text-lg MiniPortable:text-xl">ShopiLine</h1>
          <p className="text-base uppercase font-bold Tablette:text-sm mobil:text-xs MiniPortable:text-xs">official online Store</p>
          <p className="text-sm uppercase Tablette:text-xs mobil:text-xs MiniPortable:text-xs">for <b><i>fantastic</i></b> Experience</p>
        </div>
      </div>
    </>
  );
